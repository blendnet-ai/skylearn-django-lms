    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "additional_guardrail_prompt",
                    models.TextField(
                        default="",
                        help_text="additional prompt text to be added at end of each user msg for additional guardrails. (This won't be saved in conversation history)",
                    ),
                ),
