...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        # ("evaluation", "0002_assessmentgenerationconfig_assessment_type_and_more"),
        # ("evaluation", "0003_alter_assessmentattempt_type"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mode",
                    models.IntegerField(
                        choices=[("0", "Evaluation"), ("1", "Practice")], default="0"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Arguments passed in while starting the event flow.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        editable=False,
                        help_text="Id of the initiator event/person",
                        max_length=64,
                    ),
                ),
                (
                    ...
                    models.DurationField(
                        blank=True, null=True, verbose_name="Run duration"
                    ),
                ),
                (
                    "start_time",
                    models.DateTimeField(
                        auto_now_add=True,
                        null=True,
                        verbose_name="Start time of event flow",
                    ),
                ),
                (
                    "end_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Start time of event flow"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Cummulative score of evaluation",
                        max_digits=4,
                        null=True,
                    ),
                ),
                (
                    "fluency",
                    models.CharField(
                        blank=True, help_text="Fluency score", max_length=32, null=True
                    ),
                ),
                (
                    "fluency_details",
                    models.JSONField(
                        blank=True,
                        help_text="Additional fluency evaluation data",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Additional pronunciation evaluation data",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Additional coherence evaluation data",
                        null=True,
                    ),
                ),
                (
                    "grammar",
                    models.CharField(
                        blank=True, help_text="Grammar score", max_length=32, null=True
                    ),
                ),
                (
                    "grammar_details",
                    models.JSONField(
                        blank=True,
                        help_text="Additional Grammar evaluation data",
                        null=True,
                    ),
                ),
                (
                    "vocab",
                    models.CharField(
                        blank=True, help_text="Vocab score", max_length=32, null=True
                    ),
                ),
                (
                    "vocab_details",
                    models.JSONField(
                        blank=True,
                        help_text="Additional vocab evaluation data",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Additional sentiment evaluation data",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Any additional metadata related to the evaluation",
                        null=True,
                    ),
                ),
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "Partial"), (2, "Complete"), (3, "Error")],
                        default=1,
                    ),
                ),
                (
                    "ideal_response_details",
                    models.JSONField(
                        blank=True, help_text="Metadata for ideal response", null=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ("0", "Software Releated Issue"),
                            ("1", "Content Releated Issue"),
                            ("2", "Others Issue"),
                        ]
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="evaluation.assessmentattempt",
                    ),
                ),
                (
                    "question",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "processor_name",
                    models.CharField(help_text="Processor name", max_length=32),
                ),
                (
                    "result",
                    models.JSONField(
                        blank=True, help_text="All the result of the task.", null=True
                    ),
                ),
                (
                    "error",
                    models.JSONField(
                        blank=True, help_text="Error stack trace of the task", null=True
                    ),
                ),
                (
                    "retriable_error",
                    models.JSONField(
                        blank=True,
                        help_text="Error stack trace of the task, only in case of a retriable error. Last error occurred will be stored.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "compile_duration_logs",
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="Additional logs for monitoring purpose",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Log of submission compilation",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                choices=[("0", "Qualitative"), ("1", "Quantitative")], default="0"
            ),
        ),
        migrations.AddField(
            model_name="assessmentgenerationconfig",
