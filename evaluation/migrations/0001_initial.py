    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(blank=True, choices=[('0', 'Aptitude Test [Accenture]'), ('1', 'Communication Skills'), ('2', 'Psychometric Assessment'), ('3', 'Coding Assessment'), ('4', 'DSA Practice'), ('5', 'Mock Behavioural')], null=True)),
