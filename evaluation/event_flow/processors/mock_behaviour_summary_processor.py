...
class MockInterviewBehavioralProcessor():
    def __init__(self,eval_data):
        self.eval_data = eval_data
        
    def initialize(self):
        self.system_message = """
        Your task is to generate an overall summary for a behavioral interview. You will be given the evaluation data as input. Based on the inputs, provide:
