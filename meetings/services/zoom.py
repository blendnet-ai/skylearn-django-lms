...
class ZoomConferencePlatformService(BaseConferencePlatformService):
    ...
    def update_meeting(self, presenter: Presenter, meeting_id: str, start_time: datetime, end_time: datetime, subject: str) -> MeetingDetails:
        try:
            access_token = self._get_access_token()
            headers = {
                "Authorization": f"Bearer {access_token}",
    ...
    def get_meeting_attendance(self, presenter: Presenter, meeting_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            participants_url = f"{self.API_BASE_URL}/report/meetings/{meeting_id}/participants"
