    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        choices=[("RESUME_ANALYST", "Resume Analyst")], max_length=50
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="OpenAIService.llmconfigname"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="OpenAIService.openaiassistant",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    models.IntegerField(choices=[("1", "PDF"), ("2", "YouTube Video")]),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="OpenAIService.knowledgerepository",
                    ),
                ),
            ],
            options={
