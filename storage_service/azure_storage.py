...
class AzureStorageService(StorageServiceInterface):
    ...
    def copy_blob(self, source_container_name, source_blob_name, destination_container_name, destination_blob_name):
        ...
        """
        source_blob_client = self.blob_service_client.get_blob_client(source_container_name, source_blob_name)
        destination_blob_client = self.blob_service_client.get_blob_client(destination_container_name, destination_blob_name)
