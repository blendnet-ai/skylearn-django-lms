...
def populate_AFH_reporting_data(data):
    ...
    for user_id, user_profile in data['user_profiles_map'].items():
        ...
        base_profile_info = {
            ...
            "State": UserProfileRepository.fetch_value_from_form('state', user_profile.user_data),
            "District": UserProfileRepository.fetch_value_from_form('district', user_profile.user_data),
            "College Name": UserProfileRepository.fetch_value_from_form('college_name', user_profile.user_data),
            ...
            "Center Name": UserProfileRepository.fetch_value_from_form('center_name', user_profile.user_data),
            "Training Location District Name": UserProfileRepository.fetch_value_from_form('training_location_district_name', user_profile.user_data),
            "Training Location City Name": UserProfileRepository.fetch_value_from_form('training_location_city_name', user_profile.user_data),
            "DOB": UserProfileRepository.fetch_value_from_form('dob', user_profile.user_data),
            "Email ID": user.email,
            ...
            "Enrollment Status": UserProfileRepository.fetch_value_from_form('enrollment_status', user_profile.user_data),
...
def populate_course_provider_reporting_data(data):
    ...
    for report in reports_data:
        ...
        final_data.append({
            ...
            'Total Learning Time (in mins)': report.total_time_spent.total_seconds()/60,
